...
private val STUB_SOURCES = listOf(
    ...
    SourceFile.kotlin(
        ...
        class PolymorphicFieldEditor(
            ...
            override val getter: (Any) -> Any?,
            override val setter: (Any, Any?) -> Any,
            val subclasses: List<kotlin.reflect.KClass<*>>,
            val nestedFieldEditorsProvider: (kotlin.reflect.KClass<*>) -> List<FieldEditor>,
            val defaultInstanceProvider: (kotlin.reflect.KClass<*>) -> Any?,
        ) : FieldEditor
        """.trimIndent(),
    ),
    SourceFile.kotlin(
